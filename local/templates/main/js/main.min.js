...
"use strict";$((function(){var e,t,s=$("html").attr("lang"),o={ru:{fancybox:{CLOSE:"Закрыть",NEXT:"Дальше",PREV:"Назад",ERROR:"Запрошенный контент не может быть загружен. <br/> Попробуйте позже.",PLAY_START:"Начать слайдшоу",PLAY_STOP:"Остановить слайдшоу",FULL_SCREEN:"Полный экран",THUMBS:"Плиткой",DOWNLOAD:"Скачать",SHARE:"Поделиться",ZOOM:"Увеличить"}}};switch(s){case"ru":t={ru:(e=o.ru).fancybox};break;default:t={en:(e=o.en).fancybox}}var a={win:$(window),body:$("body"),nav:$(".nav"),header:$(".header"),main:$(".main"),footer:$(".footer"),btnMenu:$(".js-toggle-menu"),shadowMenu:$(".nav-shadow"),togglePhone:$(".js-toggle-phones"),togglePhoneContent:$(".header-toggle-phone__content"),toggleSearch:$(".js-toggle-search"),search:$(".header__search"),searchShadow:$(".header__search-shadow"),scrollableElement:document.querySelector(".nav__scroll"),eventMenu:function(){var e=a.win.width();a.nav.toggleClass("nav--is-open"),a.btnMenu.find(".toggle-menu__body").toggleClass("toggle-menu__body--is-active"),a.shadowMenu.toggleClass("nav-shadow--is-active"),a.nav.hasClass("nav--is-open")&&e<1200?scrollLock.disablePageScroll(a.scrollableElement):scrollLock.enablePageScroll(a.scrollableElement)},selectSearch:function(){$(".js-select").SumoSelect({search:!0,searchText:e.searchText,noMatch:e.noMatch,locale:e.locale,captionFormat:e.captionFormat,captionFormatAllSelected:e.captionFormatAllSelected})},selectNoSearch:function(){$(".js-select-no-search").SumoSelect({search:!1})}},n=$("select.js-select-model"),i=$(".js-select-model option"),l=$("select.js-select-equipment"),r=$(".js-select-equipment option"),c=$("select.js-select-body"),d=$(".js-select-body option");$(".js-select-brand").on("change",(function(){var e=$(this).find("option:selected").index(),t=$(this).find("option:selected").val();n[0].sumo.selectItem(0),n[0].sumo.reload(),l[0].sumo.selectItem(0),l[0].sumo.reload(),c[0].sumo.selectItem(0),c[0].sumo.reload(),0!==e?(n[0].sumo.enable(),i.not(":first-child").addClass("hide"),i.each((function(e){var s=$(this).val().split("-")[1];$("select.js-select-model option[value="+t+"-"+s+"]").removeClass("hide")})),n[0].sumo.reload()):(n[0].sumo.disable(),l[0].sumo.disable(),c[0].sumo.disable())})),n.on("change",(function(){var e=$(this).find("option:selected").index(),t=$(this).find("option:selected").val();l[0].sumo.selectItem(0),c[0].sumo.selectItem(0),0!==e?(l[0].sumo.enable(),r.not(":first-child").addClass("hide"),r.each((function(e){var s=$(this).val().split("-")[2];$("select.js-select-equipment option[value="+t+"-"+s+"]").removeClass("hide")}))):(c[0].sumo.selectItem(0),l[0].sumo.disable()),l[0].sumo.reload(),c[0].sumo.reload()})),l.on("change",(function(){var e=$(this).find("option:selected").index(),t=$(this).find("option:selected").val();c[0].sumo.selectItem(0),c[0].sumo.reload(),0!==e?(c[0].sumo.enable(),d.not(":first-child").addClass("hide"),d.each((function(e){var s=$(this).val().split("-")[3];$("select.js-select-body option[value="+t+"-"+s+"]").removeClass("hide")})),c[0].sumo.reload()):(c[0].sumo.selectItem(0),c[0].sumo.reload(),c[0].sumo.disable())})),a.btnMenu.on("click",(function(){a.eventMenu()})),a.shadowMenu.on("click",(function(){a.eventMenu()})),a.body.on("click",".menu__link-wrp",(function(e){a.win.width()<1200&&"A"!==e.target.tagName&&(e.preventDefault(),$(this).toggleClass("menu__link-wrp--is-active").stop(!0).next(".submenu").slideToggle())}));var p,f=0,m=1;a.win.scroll((function(){var e=a.win.scrollTop(),t=(a.win.outerWidth(),$(this).scrollTop());!function(e,t,s,o){0!==e?(s>f&&e>=o?m&&(m=0,a.header.stop(!0).animate({top:-o},300,(function(){$(this).addClass("header--fixed header--hide compensate-for-scrollbar"),a.main.css("padding-top",o)}))):m||(m=1,a.header.stop(!0).animate({top:"0"},300),a.header.removeClass("header--hide")),f=s):(m=1,a.header.stop(!0).animate({top:"0"},300,(function(){$(this).removeClass("header--fixed header--hide compensate-for-scrollbar"),a.main.removeAttr("style")})))}(e,0,t,a.header.outerHeight()),t>$(this).height()?$(".js-up").addClass("js-up--is-show"):$(".js-up").removeClass("js-up--is-show")})),a.win.scroll(),$(".js-up").on("click",(function(){$("body,html").animate({scrollTop:0},700)})),a.body.on("click",".js-accordion",(function(){$(this).toggleClass("js-accordion__ttl_active").next(".js-accordion__info").stop(!0).slideToggle()})),new Swiper(".slider",{autoplay:{delay:8e3,disableOnInteraction:!1},spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!1},speed:1200,loop:!0,pagination:{el:".slider__pagination",clickable:!0}}),document.querySelectorAll(".picture-gallery-slider").forEach((function(e){var t=e.querySelector(".picture-gallery-slider__btn--next"),s=e.querySelector(".picture-gallery-slider__btn--prev"),o=e.querySelector(".picture-gallery-slider__pagination");p=new Swiper(e,{autoplay:!1,spaceBetween:0,effect:"fade",watchOverflow:!0,observer:!0,observeParents:!0,speed:1200,loop:!0,pagination:{el:o,clickable:!0},navigation:{nextEl:t,prevEl:s}})}));var u=new Swiper(".color-options-slider",{autoplay:!1,spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!0},speed:1200,loop:!0});function h(e,t){var s,o=0,a='<div class="err_mess">Пожалуйста, заполните обязательные поля!</div>',n=t||!1,i=$(e),l=i.data("ajax"),r=i.find('input[type="email"].chk'),c=r.val();if(i.find(".err_mess,.complete").remove(),i.find(".chk").each((function(){var e=$(this);e.val()?(e.hasClass("inputfile")&&e.closest(".file").removeClass("file_err"),e.removeClass("err"),e.next(".selected").removeClass("err")):(e.hasClass("inputfile")&&e.closest(".file").addClass("file_err"),e.addClass("err"),i.find(".err_mess").remove(),i.find(".form-message").html(a),o=1)})),r.length&&(s=c,new RegExp(/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i).test(s)?r.removeClass("err"):(r.addClass("err"),i.find(".err_mess").remove(),i.find(".form-message").html(a),o=1)),0===o){if(void 0!==l){i.find("[type=submit]").prop("disabled",!0);var d=new FormData(i.get(0));return!1!==n&&d.append(n.attr("name"),n.val()),$.ajax({type:"POST",url:l,data:d,processData:!1,contentType:!1,dataType:"html",success:function(e){i.find(".err_mess,.complete").remove(),i.find("[type=submit]").prop("disabled",!1),d=JSON.parse(e),console.log(d),"Y"===d.result?(i.find('input:not([type="submit"],[type="hidden"]),textarea').val(""),i.find(".form-message").html(d.txt)):i.find(".form-message").html(d.txt)}}),!1}return i.find(".err_mess,.complete").remove(),!0}return i.find(".err_mess,.complete").remove(),i.find(".form-message").html(a),!1}u.on("slideChange",(function(){var e=$(".color-options-slider-pagination__item");e.removeClass("color-options-slider-pagination__item--is-active"),e.eq(u.realIndex).addClass("color-options-slider-pagination__item--is-active")})),a.body.on("click",".color-options-slider-pagination__item",(function(){var e=$(this),t=e.index();u.slideTo(t+1),$(".color-options-slider-pagination__item").removeClass("color-options-slider-pagination__item--is-active"),e.addClass("color-options-slider-pagination__item--is-active")})),a.body.on("click",".js-tabs__link",(function(e){e.preventDefault();var t=$(this),s=t.closest(".js-tabs"),o=s.find(".js-tabs__link"),a=s.find(".js-tabs__tab"),n=t.attr("href");o.removeClass("js-tabs__link--is-active"),s.find('.js-tabs__link[href="'+n+'"]').addClass("js-tabs__link--is-active"),a.removeClass("js-tabs__tab--is-show"),(a=$(n)).addClass("js-tabs__tab--is-show"),p.update()})),$("[data-fancybox]").fancybox({lang:s,i18n:t,animationEffect:"fade"}),a.body.on("click",".js-modal-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",afterClose:function(){$('.popup input:not([type="submit"]),.popup textarea').removeClass("err"),$(".popup .err_mess,.popup .complete").remove()}}})})),a.body.on("click",".js-ajax-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),type:"ajax",opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade"}})})),a.selectSearch(),a.selectNoSearch(),$(".js-phone-mask").mask("+375 (99) 999-99-99"),a.body.on("click",".file__info",(function(){$("input",this.parentNode).click()})),a.body.on("change",".inputfile",(function(){var e=$(this),t=e.closest(".file-wrapper"),s=t.find(".file__path"),o=t.find(".file__del"),a=s.attr("data-nofile"),n=e.val(),i=n.replace("C:\\fakepath\\","");""!==n?(s.text(i),o.addClass("show")):(s.text(a),o.removeClass("show"))})),a.body.on("click",".file__del",(function(){var e=$(this).closest(".file-wrapper"),t=e.find(".file__path"),s=t.attr("data-nofile"),o=e.find(".file__del");e.find(".inputfile").val(""),t.text(s),o.removeClass("show")})),a.body.on("change, keyup",'input:not([type="file"],input:not([type="submit"],[type="hidden"]),textarea',(function(){var e=$(this);e.hasClass("err")&&e.val()&&e.removeClass("err")})),a.body.on("submit","form",(function(e){if(void 0===$(this).attr("data-ajax"))return h(this);e.preventDefault()})),a.body.on("click","[type = submit]",(function(){return h($(this).closest("form"),$(this))})),window.vaObj=a}));