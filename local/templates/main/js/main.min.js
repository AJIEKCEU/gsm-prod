...
"use strict";$((function(){var e,t,a=$("html").attr("lang"),s={ru:{fancybox:{CLOSE:"Закрыть",NEXT:"Дальше",PREV:"Назад",ERROR:"Запрошенный контент не может быть загружен. <br/> Попробуйте позже.",PLAY_START:"Начать слайдшоу",PLAY_STOP:"Остановить слайдшоу",FULL_SCREEN:"Полный экран",THUMBS:"Плиткой",DOWNLOAD:"Скачать",SHARE:"Поделиться",ZOOM:"Увеличить"}}};switch(a){case"ru":t={ru:(e=s.ru).fancybox};break;default:t={en:(e=s.en).fancybox}}var o={win:$(window),body:$("body"),nav:$(".nav"),header:$(".header"),main:$(".main"),footer:$(".footer"),btnMenu:$(".js-toggle-menu"),shadowMenu:$(".nav-shadow"),togglePhone:$(".js-toggle-phones"),togglePhoneContent:$(".header-toggle-phone__content"),toggleSearch:$(".js-toggle-search"),search:$(".header__search"),searchShadow:$(".header__search-shadow"),scrollableElement:document.querySelector(".nav__scroll"),eventMenu:function(){var e=o.win.width();o.nav.toggleClass("nav--is-open"),o.btnMenu.find(".toggle-menu__body").toggleClass("toggle-menu__body--is-active"),o.shadowMenu.toggleClass("nav-shadow--is-active"),o.nav.hasClass("nav--is-open")&&e<1200?scrollLock.disablePageScroll(o.scrollableElement):scrollLock.enablePageScroll(o.scrollableElement)},selectSearch:function(){$(".js-select").SumoSelect({search:!0,searchText:e.searchText,noMatch:e.noMatch,locale:e.locale,captionFormat:e.captionFormat,captionFormatAllSelected:e.captionFormatAllSelected})},selectNoSearch:function(){$(".js-select-no-search").SumoSelect({search:!1})}},n=$("select.js-select-model"),i=$(".js-select-model option"),l=$("select.js-select-equipment"),r=$(".js-select-equipment option"),c=$("select.js-select-body"),d=$(".js-select-body option");$(".js-select-brand").on("change",(function(){var e=$(this).find("option:selected").index(),t=$(this).find("option:selected").val();n[0].sumo.selectItem(0),n[0].sumo.reload(),l[0].sumo.selectItem(0),l[0].sumo.reload(),c[0].sumo.selectItem(0),c[0].sumo.reload(),0!==e?(n[0].sumo.enable(),i.not(":first-child").addClass("hide"),i.each((function(e){var a=$(this).val().split("-")[1];$("select.js-select-model option[value="+t+"-"+a+"]").removeClass("hide")})),n[0].sumo.reload()):(n[0].sumo.disable(),l[0].sumo.disable(),c[0].sumo.disable())})),n.on("change",(function(){var e=$(this).find("option:selected").index(),t=$(this).find("option:selected").val();l[0].sumo.selectItem(0),c[0].sumo.selectItem(0),0!==e?(l[0].sumo.enable(),r.not(":first-child").addClass("hide"),r.each((function(e){var a=$(this).val().split("-")[2];$("select.js-select-equipment option[value="+t+"-"+a+"]").removeClass("hide")}))):(c[0].sumo.selectItem(0),l[0].sumo.disable()),l[0].sumo.reload(),c[0].sumo.reload()})),l.on("change",(function(){var e=$(this).find("option:selected").index(),t=$(this).find("option:selected").val();c[0].sumo.selectItem(0),c[0].sumo.reload(),0!==e?(c[0].sumo.enable(),d.not(":first-child").addClass("hide"),d.each((function(e){var a=$(this).val().split("-")[3];$("select.js-select-body option[value="+t+"-"+a+"]").removeClass("hide")})),c[0].sumo.reload()):(c[0].sumo.selectItem(0),c[0].sumo.reload(),c[0].sumo.disable())}));var m,u,p,f,h=document.querySelectorAll(".js-range"),v=$("select.js-currency");function b(e,t,a,s){var o=((Number(e)-Number(t))*(s/12*Math.pow(1+s/12,a))/(Math.pow(1+s/12,a)-1)).toFixed();$(".js-total").text(o)}h.forEach((function(e){var t=Number(e.dataset.min),a=Number(e.dataset.max),s=Number(e.dataset.start)||t||0;e.dataset.model,noUiSlider.create(e,{connect:[!0,!1],start:[s],range:{min:[t],max:[a]},format:wNumb({decimals:0})}),e.noUiSlider.on("update",(function(){var t=e.noUiSlider.get();"budget"===$(e).attr("data-model")&&(m=t),"advance"===$(e).attr("data-model")&&(u=t),"leaseTerm"===$(e).attr("data-model")&&(p=t),$(e.closest(".leasing-items__item")).find(".js-range-total").text(t),f=v.find("option:selected").val(),b(m,u,p,f)}))})),v.on("change",(function(){var e=$(this),t=e.find("option:selected").val(),a=e.find("option:selected").attr("data-currency");$(".js-range-currency").text(a),b(m,u,p,t)})),o.btnMenu.on("click",(function(){o.eventMenu()})),o.shadowMenu.on("click",(function(){o.eventMenu()})),o.body.on("click",".menu__link-wrp",(function(e){o.win.width()<1200&&"A"!==e.target.tagName&&(e.preventDefault(),$(this).toggleClass("menu__link-wrp--is-active").stop(!0).next(".submenu").slideToggle())}));var _,g=0,y=1;o.win.scroll((function(){var e=o.win.scrollTop(),t=(o.win.outerWidth(),$(this).scrollTop());!function(e,t,a,s){0!==e?(a>g&&e>=s?y&&(y=0,o.header.stop(!0).animate({top:-s},300,(function(){$(this).addClass("header--fixed header--hide compensate-for-scrollbar"),o.main.css("padding-top",s)}))):y||(y=1,o.header.stop(!0).animate({top:"0"},300),o.header.removeClass("header--hide")),g=a):(y=1,o.header.stop(!0).animate({top:"0"},300,(function(){$(this).removeClass("header--fixed header--hide compensate-for-scrollbar"),o.main.removeAttr("style")})))}(e,0,t,o.header.outerHeight()),t>$(this).height()?$(".js-up").addClass("js-up--is-show"):$(".js-up").removeClass("js-up--is-show")})),o.win.scroll(),$(".js-up").on("click",(function(){$("body,html").animate({scrollTop:0},700)})),o.body.on("click",".js-accordion",(function(){$(this).toggleClass("js-accordion__ttl_active").next(".js-accordion__info").stop(!0).slideToggle()})),new Swiper(".slider",{autoplay:{delay:8e3,disableOnInteraction:!1},spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!1},speed:1200,loop:!0,pagination:{el:".slider__pagination",clickable:!0}}),document.querySelectorAll(".picture-gallery-slider").forEach((function(e){var t=e.querySelector(".picture-gallery-slider__btn--next"),a=e.querySelector(".picture-gallery-slider__btn--prev"),s=e.querySelector(".picture-gallery-slider__pagination");_=new Swiper(e,{autoplay:!1,spaceBetween:0,effect:"fade",watchOverflow:!0,observer:!0,observeParents:!0,speed:1200,loop:!0,pagination:{el:s,clickable:!0},navigation:{nextEl:t,prevEl:a}})}));var w=new Swiper(".color-options-slider",{autoplay:!1,spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!0},speed:1200,loop:!0});function j(e,t){var a,s=0,o='<div class="err_mess">Пожалуйста, заполните обязательные поля!</div>',n=t||!1,i=$(e),l=i.data("ajax"),r=i.find('input[type="email"].chk'),c=r.val();if(i.find(".err_mess,.complete").remove(),i.find(".chk").each((function(){var e=$(this);e.val()?(e.hasClass("inputfile")&&e.closest(".file").removeClass("file_err"),e.removeClass("err"),e.next(".selected").removeClass("err")):(e.hasClass("inputfile")&&e.closest(".file").addClass("file_err"),e.addClass("err"),i.find(".err_mess").remove(),i.find(".form-message").html(o),s=1)})),r.length&&(a=c,new RegExp(/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i).test(a)?r.removeClass("err"):(r.addClass("err"),i.find(".err_mess").remove(),i.find(".form-message").html(o),s=1)),0===s){if(void 0!==l){i.find("[type=submit]").prop("disabled",!0);var d=new FormData(i.get(0));return!1!==n&&d.append(n.attr("name"),n.val()),$.ajax({type:"POST",url:l,data:d,processData:!1,contentType:!1,dataType:"html",success:function(e){i.find(".err_mess,.complete").remove(),i.find("[type=submit]").prop("disabled",!1),d=JSON.parse(e),console.log(d),"Y"===d.result?(i.find('input:not([type="submit"],[type="hidden"]),textarea').val(""),i.find(".form-message").html(d.txt)):i.find(".form-message").html(d.txt)}}),!1}return i.find(".err_mess,.complete").remove(),!0}return i.find(".err_mess,.complete").remove(),i.find(".form-message").html(o),!1}w.on("slideChange",(function(){var e=$(".color-options-slider-pagination__item");e.removeClass("color-options-slider-pagination__item--is-active"),e.eq(w.realIndex).addClass("color-options-slider-pagination__item--is-active")})),o.body.on("click",".color-options-slider-pagination__item",(function(){var e=$(this),t=e.index();w.slideTo(t+1),$(".color-options-slider-pagination__item").removeClass("color-options-slider-pagination__item--is-active"),e.addClass("color-options-slider-pagination__item--is-active")})),o.body.on("click",".js-tabs__link",(function(e){e.preventDefault();var t=$(this),a=t.closest(".js-tabs"),s=a.find(".js-tabs__link"),o=a.find(".js-tabs__tab"),n=t.attr("href");s.removeClass("js-tabs__link--is-active"),a.find('.js-tabs__link[href="'+n+'"]').addClass("js-tabs__link--is-active"),o.removeClass("js-tabs__tab--is-show"),(o=$(n)).addClass("js-tabs__tab--is-show"),_.update()})),$("[data-fancybox]").fancybox({lang:a,i18n:t,animationEffect:"fade"}),o.body.on("click",".js-modal-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",afterClose:function(){$('.popup input:not([type="submit"]),.popup textarea').removeClass("err"),$(".popup .err_mess,.popup .complete").remove()}}})})),o.body.on("click",".js-ajax-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),type:"ajax",opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade"}})})),o.selectSearch(),o.selectNoSearch(),$(".js-phone-mask").mask("+375 (99) 999-99-99"),o.body.on("click",".file__info",(function(){$("input",this.parentNode).click()})),o.body.on("change",".inputfile",(function(){var e=$(this),t=e.closest(".file-wrapper"),a=t.find(".file__path"),s=t.find(".file__del"),o=a.attr("data-nofile"),n=e.val(),i=n.replace("C:\\fakepath\\","");""!==n?(a.text(i),s.addClass("show")):(a.text(o),s.removeClass("show"))})),o.body.on("click",".file__del",(function(){var e=$(this).closest(".file-wrapper"),t=e.find(".file__path"),a=t.attr("data-nofile"),s=e.find(".file__del");e.find(".inputfile").val(""),t.text(a),s.removeClass("show")})),o.body.on("change, keyup",'input:not([type="file"],input:not([type="submit"],[type="hidden"]),textarea',(function(){var e=$(this);e.hasClass("err")&&e.val()&&e.removeClass("err")})),o.body.on("submit","form",(function(e){if(void 0===$(this).attr("data-ajax"))return j(this);e.preventDefault()})),o.body.on("click","[type = submit]",(function(){return j($(this).closest("form"),$(this))})),window.vaObj=o}));