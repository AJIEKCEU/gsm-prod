...
"use strict";$((function(){var e,t,a=this,o=$("html").attr("lang"),n={ru:{fancybox:{CLOSE:"Закрыть",NEXT:"Дальше",PREV:"Назад",ERROR:"Запрошенный контент не может быть загружен. <br/> Попробуйте позже.",PLAY_START:"Начать слайдшоу",PLAY_STOP:"Остановить слайдшоу",FULL_SCREEN:"Полный экран",THUMBS:"Плиткой",DOWNLOAD:"Скачать",SHARE:"Поделиться",ZOOM:"Увеличить"}}};switch(o){case"ru":t={ru:(e=n.ru).fancybox};break;default:t={en:(e=n.en).fancybox}}var s,i,r,l,c={win:$(window),body:$("body"),nav:$(".nav"),header:$(".header"),main:$(".main"),footer:$(".footer"),btnMenu:$(".js-toggle-menu"),shadowMenu:$(".nav-shadow"),togglePhone:$(".js-toggle-phones"),togglePhoneContent:$(".header-toggle-phone__content"),toggleSearch:$(".js-toggle-search"),search:$(".header__search"),searchShadow:$(".header__search-shadow"),scrollableElement:document.querySelector(".nav__scroll"),eventMenu:function(){var e=c.win.width();c.nav.toggleClass("nav--is-open"),c.btnMenu.find(".toggle-menu__body").toggleClass("toggle-menu__body--is-active"),c.shadowMenu.toggleClass("nav-shadow--is-active"),c.nav.hasClass("nav--is-open")&&e<1200?scrollLock.disablePageScroll(c.scrollableElement):scrollLock.enablePageScroll(c.scrollableElement)},selectSearch:function(){$(".js-select").SumoSelect({search:!0,searchText:e.searchText,noMatch:e.noMatch,locale:e.locale,captionFormat:e.captionFormat,captionFormatAllSelected:e.captionFormatAllSelected})},selectNoSearch:function(){$(".js-select-no-search").SumoSelect({search:!1})}},d=document.querySelectorAll(".js-range"),f=$("select.js-currency");function p(e,t,a,o){var n=((Number(e)-Number(t))*(o/12*Math.pow(1+o/12,a))/(Math.pow(1+o/12,a)-1)).toFixed();$(".js-total").text(n)}d.forEach((function(e){var t=Number(e.dataset.min),o=Number(e.dataset.max),n=Number(e.dataset.start)||t||0,c=e.dataset.model;noUiSlider.create(e,{connect:[!0,!1],start:[n],range:{min:[t],max:[o]},format:wNumb({decimals:0})}),e.noUiSlider.on("update",(function(){var t=e.noUiSlider.get();a[c]=t,"budget"===$(e).attr("data-model")&&(s=t),"advance"===$(e).attr("data-model")&&(i=t),"leaseTerm"===$(e).attr("data-model")&&(r=t),$(e.closest(".leasing-items__item")).find(".js-range-total").val(t),l=f.find("option:selected").val(),p(s,i,r,l)}))})),f.on("change",(function(){var e=$(this),t=e.find("option:selected").val(),a=e.find("option:selected").attr("data-currency");$(".js-range-currency").text(a),p(s,i,r,t)})),$(".js-range-total").on("change",(function(){var e=$(this),t=e.val(),a=e.closest(".leasing-items__item").find(".js-range"),o=e.attr("data-model"),n=Number(a.attr("data-min")),s=Number(a.attr("data-max"));t>s?e.val(s):t.length&&t<=n&&e.val(n),document.querySelectorAll(".js-range").forEach((function(e){$(e).attr("data-model")===o&&e.noUiSlider.set(Number(t))}))})),c.btnMenu.on("click",(function(){c.eventMenu()})),c.shadowMenu.on("click",(function(){c.eventMenu()})),c.body.on("click",".menu__link-wrp",(function(e){c.win.width()<1200&&"A"!==e.target.tagName&&(e.preventDefault(),$(this).toggleClass("menu__link-wrp--is-active").stop(!0).next(".submenu").slideToggle())}));var u,m=0,h=1;c.win.scroll((function(){var e=c.win.scrollTop(),t=(c.win.outerWidth(),$(this).scrollTop());!function(e,t,a,o){0!==e?(a>m&&e>=o?h&&(h=0,c.header.stop(!0).animate({top:-o},300,(function(){$(this).addClass("header--fixed header--hide compensate-for-scrollbar"),c.main.css("padding-top",o)}))):h||(h=1,c.header.stop(!0).animate({top:"0"},300),c.header.removeClass("header--hide")),m=a):(h=1,c.header.stop(!0).animate({top:"0"},300,(function(){$(this).removeClass("header--fixed header--hide compensate-for-scrollbar"),c.main.removeAttr("style")})))}(e,0,t,c.header.outerHeight()),t>$(this).height()?$(".js-up").addClass("js-up--is-show"):$(".js-up").removeClass("js-up--is-show")})),c.win.scroll(),$(".js-anchor").on("click",(function(){var e=$(this).attr("href");return $("html, body").animate({scrollTop:$(e).offset().top},{duration:370,easing:"linear"}),!1})),$(".js-up").on("click",(function(){$("body,html").animate({scrollTop:0},700)})),c.body.on("click",".js-accordion",(function(){$(this).toggleClass("js-accordion__ttl_active").next(".js-accordion__info").stop(!0).slideToggle()})),new Swiper(".slider",{autoplay:{delay:8e3,disableOnInteraction:!1},spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!1},speed:1200,loop:!0,pagination:{el:".slider__pagination",clickable:!0}}),document.querySelectorAll(".picture-gallery-slider").forEach((function(e){var t=e.querySelector(".picture-gallery-slider__btn--next"),a=e.querySelector(".picture-gallery-slider__btn--prev"),o=e.querySelector(".picture-gallery-slider__pagination");u=new Swiper(e,{autoplay:!1,spaceBetween:0,effect:"fade",watchOverflow:!0,observer:!0,observeParents:!0,speed:1200,loop:!0,pagination:{el:o,clickable:!0},navigation:{nextEl:t,prevEl:a}})}));var v=new Swiper(".color-options-slider",{autoplay:!1,spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!0},speed:1200,loop:!0});function g(e,t){var a,o=0,n='<div class="form-message form-message--error">Заполните обязательные поля!</div>',s=t||!1,i=$(e),r=i.data("ajax"),l=i.find('input[type="email"].chk'),c=l.val();if(i.find(".form-message").remove(),i.find(".chk").each((function(){var e=$(this);e.val()?(e.hasClass("inputfile")&&e.closest(".file").removeClass("file_err"),e.removeClass("err"),e.next(".selected").removeClass("err")):(e.hasClass("inputfile")&&e.closest(".file").addClass("file_err"),e.addClass("err"),i.find(".form-message").remove(),s.after(n),o=1)})),l.length&&(a=c,new RegExp(/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i).test(a)?l.removeClass("err"):(l.addClass("err"),i.find(".form-message").remove(),s.after(n),o=1)),0===o){if(void 0!==r){i.find("[type=submit]").prop("disabled",!0);var d=new FormData(i.get(0));return!1!==s&&d.append(s.attr("name"),s.val()),$.ajax({type:"POST",url:r,data:d,processData:!1,contentType:!1,dataType:"html",success:function(e){i.find(".form-message").remove(),i.find("[type=submit]").prop("disabled",!1),"Y"===(d=JSON.parse(e)).result?(i.find('input:not([type="submit"],[type="hidden"]),textarea').val(""),s.after(d.html)):s.after(d.html)}}),!1}return i.find(".form-message").remove(),!0}return i.find(".form-message").remove(),s.after(n),!1}v.on("slideChange",(function(){var e=$(".color-options-slider-pagination__item");e.removeClass("color-options-slider-pagination__item--is-active"),e.eq(v.realIndex).addClass("color-options-slider-pagination__item--is-active")})),c.body.on("click",".color-options-slider-pagination__item",(function(){var e=$(this),t=e.index();v.slideTo(t+1),$(".color-options-slider-pagination__item").removeClass("color-options-slider-pagination__item--is-active"),e.addClass("color-options-slider-pagination__item--is-active")})),c.body.on("click",".js-tabs__link",(function(e){e.preventDefault();var t=$(this),a=t.closest(".js-tabs"),o=a.find(".js-tabs__link"),n=a.find(".js-tabs__tab"),s=t.attr("href");o.removeClass("js-tabs__link--is-active"),a.find('.js-tabs__link[href="'+s+'"]').addClass("js-tabs__link--is-active"),n.removeClass("js-tabs__tab--is-show"),(n=$(s)).addClass("js-tabs__tab--is-show"),u.update()})),$("[data-fancybox]").fancybox({lang:o,i18n:t,animationEffect:"fade"}),c.body.on("click",".js-modal-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",afterClose:function(){$('.popup input:not([type="submit"]),.popup textarea').removeClass("err"),$(".popup .err_mess,.popup .complete").remove()}}})})),c.body.on("click",".js-ajax-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),type:"ajax",opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade"}})})),c.selectSearch(),c.selectNoSearch(),$(".js-phone-mask").mask("+375 (99) 999-99-99"),c.body.on("click",".file__info",(function(){$("input",this.parentNode).click()})),c.body.on("change",".inputfile",(function(){var e=$(this),t=e.closest(".file-wrapper"),a=t.find(".file__path"),o=t.find(".file__del"),n=a.attr("data-nofile"),s=e.val(),i=s.replace("C:\\fakepath\\","");""!==s?(a.text(i),o.addClass("show")):(a.text(n),o.removeClass("show"))})),c.body.on("click",".file__del",(function(){var e=$(this).closest(".file-wrapper"),t=e.find(".file__path"),a=t.attr("data-nofile"),o=e.find(".file__del");e.find(".inputfile").val(""),t.text(a),o.removeClass("show")})),c.body.on("change, keyup",'input:not([type="file"],input:not([type="submit"],[type="hidden"]),textarea',(function(){var e=$(this);e.hasClass("err")&&e.val()&&e.removeClass("err")})),c.body.on("submit","form",(function(e){if(void 0===$(this).attr("data-ajax"))return g(this);e.preventDefault()})),c.body.on("click","[type = submit]",(function(){return g($(this).closest("form"),$(this))})),window.vaObj=c}));