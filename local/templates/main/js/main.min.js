...
"use strict";$((function(){var e,t,a=this,o=$("html").attr("lang"),s={ru:{fancybox:{CLOSE:"Закрыть",NEXT:"Дальше",PREV:"Назад",ERROR:"Запрошенный контент не может быть загружен. <br/> Попробуйте позже.",PLAY_START:"Начать слайдшоу",PLAY_STOP:"Остановить слайдшоу",FULL_SCREEN:"Полный экран",THUMBS:"Плиткой",DOWNLOAD:"Скачать",SHARE:"Поделиться",ZOOM:"Увеличить"}}};switch(o){case"ru":t={ru:(e=s.ru).fancybox};break;default:t={en:(e=s.en).fancybox}}var n={win:$(window),body:$("body"),nav:$(".nav"),header:$(".header"),main:$(".main"),footer:$(".footer"),btnMenu:$(".js-toggle-menu"),shadowMenu:$(".nav-shadow"),togglePhone:$(".js-toggle-phones"),togglePhoneContent:$(".header-toggle-phone__content"),toggleSearch:$(".js-toggle-search"),search:$(".header__search"),searchShadow:$(".header__search-shadow"),scrollableElement:document.querySelector(".nav__scroll"),eventMenu:function(){var e=n.win.width();n.nav.toggleClass("nav--is-open"),n.btnMenu.find(".toggle-menu__body").toggleClass("toggle-menu__body--is-active"),n.shadowMenu.toggleClass("nav-shadow--is-active"),n.nav.hasClass("nav--is-open")&&e<1200?scrollLock.disablePageScroll(n.scrollableElement):scrollLock.enablePageScroll(n.scrollableElement)},selectSearch:function(){$(".js-select").SumoSelect({search:!0,searchText:e.searchText,noMatch:e.noMatch,locale:e.locale,captionFormat:e.captionFormat,captionFormatAllSelected:e.captionFormatAllSelected})},selectNoSearch:function(){$(".js-select-no-search").SumoSelect({search:!1})}},i=$("select.js-select-model"),l=$(".js-select-model option"),r=$("select.js-select-equipment"),c=$(".js-select-equipment option"),d=$("select.js-select-body"),u=$(".js-select-body option");$(".js-select-brand").on("change",(function(){var e=$(this).find("option:selected").index(),t=$(this).find("option:selected").val();i[0].sumo.selectItem(0),i[0].sumo.reload(),r[0].sumo.selectItem(0),r[0].sumo.reload(),d[0].sumo.selectItem(0),d[0].sumo.reload(),0!==e?(i[0].sumo.enable(),l.not(":first-child").addClass("hide"),l.each((function(e){var a=$(this).val().split("-")[1];$("select.js-select-model option[value="+t+"-"+a+"]").removeClass("hide")})),i[0].sumo.reload()):(i[0].sumo.disable(),r[0].sumo.disable(),d[0].sumo.disable())})),i.on("change",(function(){var e=$(this).find("option:selected").index(),t=$(this).find("option:selected").val();r[0].sumo.selectItem(0),d[0].sumo.selectItem(0),0!==e?(r[0].sumo.enable(),c.not(":first-child").addClass("hide"),c.each((function(e){var a=$(this).val().split("-")[2];$("select.js-select-equipment option[value="+t+"-"+a+"]").removeClass("hide")}))):(d[0].sumo.selectItem(0),r[0].sumo.disable()),r[0].sumo.reload(),d[0].sumo.reload()})),r.on("change",(function(){var e=$(this).find("option:selected").index(),t=$(this).find("option:selected").val();d[0].sumo.selectItem(0),d[0].sumo.reload(),0!==e?(d[0].sumo.enable(),u.not(":first-child").addClass("hide"),u.each((function(e){var a=$(this).val().split("-")[3];$("select.js-select-body option[value="+t+"-"+a+"]").removeClass("hide")})),d[0].sumo.reload()):(d[0].sumo.selectItem(0),d[0].sumo.reload(),d[0].sumo.disable())}));var f,m,p,h,v=document.querySelectorAll(".js-range"),b=$("select.js-currency");function g(e,t,a,o){var s=((Number(e)-Number(t))*(o/12*Math.pow(1+o/12,a))/(Math.pow(1+o/12,a)-1)).toFixed();$(".js-total").text(s)}v.forEach((function(e){var t=Number(e.dataset.min),o=Number(e.dataset.max),s=Number(e.dataset.start)||t||0,n=e.dataset.model;noUiSlider.create(e,{connect:[!0,!1],start:[s],range:{min:[t],max:[o]},format:wNumb({decimals:0})}),e.noUiSlider.on("update",(function(){var t=e.noUiSlider.get();a[n]=t,"budget"===$(e).attr("data-model")&&(f=t),"advance"===$(e).attr("data-model")&&(m=t),"leaseTerm"===$(e).attr("data-model")&&(p=t),$(e.closest(".leasing-items__item")).find(".js-range-total").text(t),h=b.find("option:selected").val(),g(f,m,p,h)}))})),b.on("change",(function(){var e=$(this),t=e.find("option:selected").val(),a=e.find("option:selected").attr("data-currency");$(".js-range-currency").text(a),g(f,m,p,t)})),n.btnMenu.on("click",(function(){n.eventMenu()})),n.shadowMenu.on("click",(function(){n.eventMenu()})),n.body.on("click",".menu__link-wrp",(function(e){n.win.width()<1200&&"A"!==e.target.tagName&&(e.preventDefault(),$(this).toggleClass("menu__link-wrp--is-active").stop(!0).next(".submenu").slideToggle())}));var _,y=0,w=1;n.win.scroll((function(){var e=n.win.scrollTop(),t=(n.win.outerWidth(),$(this).scrollTop());!function(e,t,a,o){0!==e?(a>y&&e>=o?w&&(w=0,n.header.stop(!0).animate({top:-o},300,(function(){$(this).addClass("header--fixed header--hide compensate-for-scrollbar"),n.main.css("padding-top",o)}))):w||(w=1,n.header.stop(!0).animate({top:"0"},300),n.header.removeClass("header--hide")),y=a):(w=1,n.header.stop(!0).animate({top:"0"},300,(function(){$(this).removeClass("header--fixed header--hide compensate-for-scrollbar"),n.main.removeAttr("style")})))}(e,0,t,n.header.outerHeight()),t>$(this).height()?$(".js-up").addClass("js-up--is-show"):$(".js-up").removeClass("js-up--is-show")})),n.win.scroll(),$(".js-up").on("click",(function(){$("body,html").animate({scrollTop:0},700)})),n.body.on("click",".js-accordion",(function(){$(this).toggleClass("js-accordion__ttl_active").next(".js-accordion__info").stop(!0).slideToggle()})),new Swiper(".slider",{autoplay:{delay:8e3,disableOnInteraction:!1},spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!1},speed:1200,loop:!0,pagination:{el:".slider__pagination",clickable:!0}}),document.querySelectorAll(".picture-gallery-slider").forEach((function(e){var t=e.querySelector(".picture-gallery-slider__btn--next"),a=e.querySelector(".picture-gallery-slider__btn--prev"),o=e.querySelector(".picture-gallery-slider__pagination");_=new Swiper(e,{autoplay:!1,spaceBetween:0,effect:"fade",watchOverflow:!0,observer:!0,observeParents:!0,speed:1200,loop:!0,pagination:{el:o,clickable:!0},navigation:{nextEl:t,prevEl:a}})}));var j=new Swiper(".color-options-slider",{autoplay:!1,spaceBetween:0,effect:"fade",fadeEffect:{crossFade:!0},speed:1200,loop:!0});function C(e,t){var a,o=0,s='<div class="form-message form-message--error">Заполните обязательные поля!</div>',n=t||!1,i=$(e),l=i.data("ajax"),r=i.find('input[type="email"].chk'),c=r.val();if(i.find(".form-message").remove(),i.find(".chk").each((function(){var e=$(this);e.val()?(e.hasClass("inputfile")&&e.closest(".file").removeClass("file_err"),e.removeClass("err"),e.next(".selected").removeClass("err")):(e.hasClass("inputfile")&&e.closest(".file").addClass("file_err"),e.addClass("err"),i.find(".form-message").remove(),n.after(s),o=1)})),r.length&&(a=c,new RegExp(/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i).test(a)?r.removeClass("err"):(r.addClass("err"),i.find(".form-message").remove(),n.after(s),o=1)),0===o){if(void 0!==l){i.find("[type=submit]").prop("disabled",!0);var d=new FormData(i.get(0));return!1!==n&&d.append(n.attr("name"),n.val()),$.ajax({type:"POST",url:l,data:d,processData:!1,contentType:!1,dataType:"html",success:function(e){i.find(".form-message").remove(),i.find("[type=submit]").prop("disabled",!1),"Y"===(d=JSON.parse(e)).result?(i.find('input:not([type="submit"],[type="hidden"]),textarea').val(""),n.after(d.html)):n.after(d.html)}}),!1}return i.find(".form-message").remove(),!0}return i.find(".form-message").remove(),n.after(s),!1}j.on("slideChange",(function(){var e=$(".color-options-slider-pagination__item");e.removeClass("color-options-slider-pagination__item--is-active"),e.eq(j.realIndex).addClass("color-options-slider-pagination__item--is-active")})),n.body.on("click",".color-options-slider-pagination__item",(function(){var e=$(this),t=e.index();j.slideTo(t+1),$(".color-options-slider-pagination__item").removeClass("color-options-slider-pagination__item--is-active"),e.addClass("color-options-slider-pagination__item--is-active")})),n.body.on("click",".js-tabs__link",(function(e){e.preventDefault();var t=$(this),a=t.closest(".js-tabs"),o=a.find(".js-tabs__link"),s=a.find(".js-tabs__tab"),n=t.attr("href");o.removeClass("js-tabs__link--is-active"),a.find('.js-tabs__link[href="'+n+'"]').addClass("js-tabs__link--is-active"),s.removeClass("js-tabs__tab--is-show"),(s=$(n)).addClass("js-tabs__tab--is-show"),_.update()})),$("[data-fancybox]").fancybox({lang:o,i18n:t,animationEffect:"fade"}),n.body.on("click",".js-modal-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",afterClose:function(){$('.popup input:not([type="submit"]),.popup textarea').removeClass("err"),$(".popup .err_mess,.popup .complete").remove()}}})})),n.body.on("click",".js-ajax-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),type:"ajax",opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade"}})})),n.selectSearch(),n.selectNoSearch(),$(".js-phone-mask").mask("+375 (99) 999-99-99"),n.body.on("click",".file__info",(function(){$("input",this.parentNode).click()})),n.body.on("change",".inputfile",(function(){var e=$(this),t=e.closest(".file-wrapper"),a=t.find(".file__path"),o=t.find(".file__del"),s=a.attr("data-nofile"),n=e.val(),i=n.replace("C:\\fakepath\\","");""!==n?(a.text(i),o.addClass("show")):(a.text(s),o.removeClass("show"))})),n.body.on("click",".file__del",(function(){var e=$(this).closest(".file-wrapper"),t=e.find(".file__path"),a=t.attr("data-nofile"),o=e.find(".file__del");e.find(".inputfile").val(""),t.text(a),o.removeClass("show")})),n.body.on("change, keyup",'input:not([type="file"],input:not([type="submit"],[type="hidden"]),textarea',(function(){var e=$(this);e.hasClass("err")&&e.val()&&e.removeClass("err")})),n.body.on("submit","form",(function(e){if(void 0===$(this).attr("data-ajax"))return C(this);e.preventDefault()})),n.body.on("click","[type = submit]",(function(){return C($(this).closest("form"),$(this))})),window.vaObj=n}));